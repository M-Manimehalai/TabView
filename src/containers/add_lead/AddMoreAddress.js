...
class AddMoreAddress extends Component {
    constructor(props) {
        super(props);
        this.state = {
            address:'',
    ...
    render(){
        ...
        <View style={styles.container}>
            <Card style={styles.addressListCard}>
                <View style={styles.addressRow}>
                    <View style={[styles.addressColumn,style={alignItems:'flex-start'}]}>
                        <Text style={styles.label}>{Labels.address1}</Text>
                    </View>
                ...
                <View style={styles.addressRow}>
                    <View style={[styles.addressColumn,style={alignItems:'flex-start'}]}>
                        <Text style={styles.addressTextAreaText}>
                            ${this.props.addressInformation.address},${this.props.addressInformation.pincode}, ${this.props.addressInformation.country}, ${this.props.addressInformation.state},${this.props.addressInformation.city}
                        </Text>
                    </View>
                </View>
...
const styles = EStyleSheet.create({
    ...
    cardContainer: { backgroundColor: CommonColors.white,padding:Labels.p15,height:536,marginTop:Labels.m1,borderRadius:0},
    addressListCard:{  marginTop: Labels.m2,backgroundColor: CommonColors.white,padding:Labels.p15,height:100,borderRadius:0},
    ...
    addressColumn: { flexDirection: 'column', flex: 1 ,alignItems: 'center'},
    bottomCard: { backgroundColor: CommonColors.white,height:80,padding:Labels.p10,marginTop:3},
    icon: {fontSize: 20,marginHorizontal: 5},
    iconContainer: {flexDirection: 'row',alignItems: 'flex-end',justifyContent: 'flex-end'},
    addressTextAreaText:{color:CommonColors.black,fontWeight:'bold'},
    label:{color:CommonColors.black}
});

const mapStateToProps = (state) => {
    return {
        addressInformation:state.addressInfoReducer.addressInfoList
    };
    console.log('menu page value asscessed',addressInfoList)
  };
export default connect(mapStateToProps)(AddMoreAddress);