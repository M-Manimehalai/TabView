...
import LeadFilter from '../leadfolder/LeadFilter'


let entireScreenWidth = Dimensions.get('window').width;
EStyleSheet.build({ $rem: entireScreenWidth / 380 });
export default class ActivitySelfJoint extends Component {
    constructor(props) {
        super(props)
        this.state = {
            searchInput: '',
    ...
    menuCardValue = (val) => {
     ...
     menuCardClick =(val) => {
     this.props.navigation.navigate('activitydetails',{selectedItem : val})
     }
    render() {
        const { navigation, dataProp } = this.props;
        ...
        return (
            <View style={styles.background}>
                ...
                <View style={styles.searchBoxContainer}>
                    ...
                    <TouchableOpacity
                        onPress={() => this.ActivityFilter.open()}
                    >
                         <Image
                    ...
                    >
                     <ActivityFilter 
                          closeRBSheet={() => {this.ActivityFilter.close()}}
                        /> 
                    </RBSheet>
                ...
                <RBSheet
                    ...
                    >
                      <LeadFilter
                          closeRBSheet={() => {this.LeadFilter.close()}}
                      />
                    </RBSheet >
                <ScrollView>
                    <View style={styles.scrollEndSpace}>
                        ...
                        {selfJoint.map((item) => (
                            <View key={item.name}>
                                <TouchableOpacity onPress={() => this.menuCardClick(item)} >
                                <ActivityCard
